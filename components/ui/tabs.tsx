...
>(({ className, ...props }, ref) => (
    <TabsPrimitive.List
        ref={ref}
        className={cn(
            "inline-flex items-center justify-center rounded-3xl bg-transparent p-2 text-muted-foreground",
            className
        )}
        {...props}
    />
